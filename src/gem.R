...
#source('src/prep-input-privatetruck.r')
source('src/prep-inputs-personal-charging-HDV1.R')
...
#source('src/plots-simplified-modified.R')
#####################################################################################
...
#      args<-'input/experiments/truckfractionSmartCharging.yaml'
#    args<-'input/experiments/truckb150ConversionEfficiency.yaml'
#   args<-'input/experiments/truckbatteryCapitalCost.yaml'
#   args<-'input/experiments/truckelectrificationPenetration.yaml'
    
#     args<-'input/experiments/base.yaml'
#     args<-'input/experiments/humanfactorandEVpenetration.yaml'
#     args<-'input/experiments/humanfactor.yaml'
#args<-'input/experiments/biketocarfactor.yaml'
#     args<-'input/experiments/bikechargercost.yaml'
...
if(!args$plots){ # only prep and run model if *not* in plot-only mode
  ...
  for(i in runs.to.run){
    ...
    gc()
    inputs.personal.charging.truck <- prep.inputs.personal.charging.hdv(exper$run[i],exper$param.names,common.inputs,inputs.truck)
    gc()
    inputs.grid <- prep.inputs.grid(exper$run[i],exper$param.names,common.inputs) 
  
    inputs$sets <- c(common.inputs$sets,inputs.mobility$sets,inputs.grid$sets,inputs.personal.charging$sets,inputs.personal.charging.truck$sets,inputs.truck$sets,inputs.bike$sets)
    inputs$parameters <- c(common.inputs$parameters,inputs.mobility$parameters,inputs.grid$parameters,inputs.personal.charging$parameters,inputs.personal.charging.truck$parameters,inputs.truck$parameters,inputs.bike$parameters)
