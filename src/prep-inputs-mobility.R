...
prep.inputs.mobility <- function(exper.row,param.names,common.inputs){
  ...
  dem[d=='0-2',trips:= trips*max(0,(1-biketocar[1]*biketocarfactor))]
  dem[d=='2-5',trips:= trips*max(0,(1-biketocar[2]*biketocarfactor))]
  dem[d=='5-10',trips:= trips*max(0,(1-biketocar[2]*biketocarfactor))]
  dem[d=='10-20',trips:= trips*max(0,(1-biketocar[2]*biketocarfactor))]
